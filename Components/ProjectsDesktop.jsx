...
export default function ProjectsDesktop({ projects }) {
  ...
  return (
    <div className="flex flex-col gap-[128px]">
      {projects.map((project, index) => {
        const hasLink = !!project.url; // check if hyperlink exists
        ...
        return (
          ...
          >
            ...
            >
              ...
              {/* If link exists → wrap in <a>, otherwise just div */}
              {hasLink ? (
                <a
                  href={project.url}
                  target="_blank"
                  rel="noopener noreferrer"
                  className="relative z-10 border border-[rgba(0,0,0,0.04)] block overflow-hidden"
                >
            ...
            {/* ================= TEXT SIDE ================= */}
            <div className="flex-1 w-full pt-4 lg:pl-[60px]">
              {/* TITLE + YEAR */}
              <div
              ...
              >
                ...
                {/* Year pushed properly to right */}
                <span className="ml-6">{project.year}</span>
              </div>

              {/* GREEN BAR + DIVIDER */}
              <div className="flex w-full items-center mt-2">
                <div className="w-[7px] h-[16px] bg-[#00CC61]" />
                <div className="flex-1 h-[1px] bg-[#000000] hidden lg:block ml-2" />
              </div>
